import { Component, Directive, EventEmitter, HostListener, Input, NgModule, Output, Renderer2, ViewChild } from '@angular/core';
...
var SidebarJSComponent = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        var /** @type {?} */ userConfig = this.sidebarjsConfig;
        var /** @type {?} */ baseConfig = this.defineConfigDomElements();
        this.setSidebarAttributes(this.sidebarjsName, baseConfig);
        this.sidebarService.create(__assign({}, userConfig, baseConfig, { onOpen: function () {
                _this.open.emit();
            }, onClose: function () {
                _this.close.emit();
            }, onChangeVisibility: function (changes) {
                _this.changeVisibility.emit(changes);
            } }));
    };
    /**
     * @return {?}
     ...
     * @return {?}
     */
    function (sidebarName, baseConfig) {
        if (sidebarName === void 0) { sidebarName = ''; }
