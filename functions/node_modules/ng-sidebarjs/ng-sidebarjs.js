...
class SidebarJSComponent {
     ...
     */
    ngAfterContentInit() {
        const /** @type {?} */ userConfig = this.sidebarjsConfig;
        const /** @type {?} */ baseConfig = this.defineConfigDomElements();
        this.setSidebarAttributes(this.sidebarjsName, baseConfig);
        this.sidebarService.create(Object.assign({}, userConfig, baseConfig, { onOpen: () => {
                this.open.emit();
            }, onClose: () => {
                this.close.emit();
     ...
     * @return {?}
     */
    setSidebarAttributes(sidebarName = '', baseConfig) {
